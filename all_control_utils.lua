...
do
	...
	zo_utils.builds["control_stage/prototype-util"] = 3
	...
	zo_utils.get_recipes_by_product_and_its_predecessors = util.get_recipes_by_product_and_its_predecessors
	...
	zo_utils.get_recipes_by_ingredient_and_its_successors = util.get_recipes_by_ingredient_and_its_successors
	util = require("lualibs/control_stage/biter-util")
	zo_utils.builds["control_stage/biter-util"] = 1
