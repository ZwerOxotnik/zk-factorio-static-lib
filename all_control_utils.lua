...
do
	...
	zo_utils.builds["control_stage/force-util"] = 10
	zo_utils.has_researched_any = util.has_researched_any
	zo_utils.change_techs_safely = util.change_techs_safely
	zo_utils.get_diplomacy_stance = util.get_diplomacy_stance
	zo_utils.get_enemy_forces = util.get_enemy_forces
	...
	zo_utils.get_forces_by_relations = util.get_forces_by_relations
	...
	zo_utils.has_researched_all = util.has_researched_all
	...
	zo_utils.builds["control_stage/entity-util"] = 12
	zo_utils.disconnect_wires_by_force = util.disconnect_wires_by_force
	...
	zo_utils.builds["control_stage/player-util"] = 12
	...
	zo_utils.create_new_character_safely = util.create_new_character_safely
	...
	zo_utils.builds["control_stage/inventory-util"] = 2
	zo_utils.add_items = util.add_items
	zo_utils.has_all_items = util.has_all_items
	...
	zo_utils.has_any_item = util.has_any_item
	...
	zo_utils.builds["control_stage/surface-util"] = 3
	...
	zo_utils.fill_chunk_with_tiles = util.fill_chunk_with_tiles
	...
	util = require("lualibs/control_stage/rcon-util")
	zo_utils.builds["control_stage/rcon-util"] = 3
	zo_utils.expose_global_data = util.expose_global_data
	util = require("lualibs/control_stage/remote-interface-util")
	zo_utils.builds["control_stage/remote-interface-util"] = 3
	zo_utils.expose_global_data = util.expose_global_data
	util = require("lualibs/control_stage/tech-util")
	zo_utils.builds["control_stage/tech-util"] = 1
	zo_utils.remove_invalid_techs = util.remove_invalid_techs
	util = require("lualibs/control_stage/item-util")
	zo_utils.builds["control_stage/item-util"] = 1
	zo_utils.items_into_dictionary = util.items_into_dictionary
	zo_utils.items_into_SimpleItemStacks = util.items_into_SimpleItemStacks
	zo_utils.remove_not_existing_items = util.remove_not_existing_items
	util = require("lualibs/control_stage/data-util")
	zo_utils.builds["control_stage/data-util"] = 1
	zo_utils.get_valid_prototypes = util.get_valid_prototypes
	zo_utils.remove_invalid_prototypes = util.remove_invalid_prototypes
	zo_utils.get_invalid_prototypes = util.get_invalid_prototypes
end
zo_utils.build = 64
