...
local options = {
	...
	mapLines = false, -- if true, compiled files will contain comments at the end of each line indicating the associated line and source file. Needed for error rewriting.
...
candran_to_lua("./all_data_utils.can", "./all_data_utils.lua")
candran_to_lua("./all_control_utils.can", "./all_control_utils.lua")
